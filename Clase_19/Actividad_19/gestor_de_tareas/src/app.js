import  appi  from './routes/task.js'; // Importamos las rutas de los items
...
const PORT = process.env.PORT || 4000; // Puerto donde correrá el servidor
...
app.use('/api/tasks', appi); // Definimos las rutas para gestionar los items
